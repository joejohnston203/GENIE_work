//
// File generated by rootcint at Fri Nov 20 18:43:20 2015
...
namespace ROOTDict {
   ...
   static ROOT::TGenericClassInfo *GenerateInitInstanceLocal(const ::genie::PathLengthList*)
   {
      ...
      static ::ROOT::TGenericClassInfo 
         instance("genie::PathLengthList", "/home/joe/GENIE_work/GENIE_v2.10.0/src//EVGDrivers/PathLengthList.h", 40,
...
/* genie::GEVGPool */
static int G___ROOT_DICT_EVGDrivers_454_0_1(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
...
static int G___ROOT_DICT_EVGDrivers_454_0_2(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
      G__letint(result7, 85, (long) ((const genie::GEVGPool*) G__getstructoffset())->FindDriver(*(genie::InitialState*) libp->para[0].ref));
   return(1 || funcname || hash || result7 || libp) ;
}

static int G___ROOT_DICT_EVGDrivers_454_0_3(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
      G__letint(result7, 85, (long) ((const genie::GEVGPool*) G__getstructoffset())->FindDriver(*((string*) G__int(libp->para[0]))));
   return(1 || funcname || hash || result7 || libp) ;
}

static int G___ROOT_DICT_EVGDrivers_454_0_4(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
...
// automatic copy constructor
static int G___ROOT_DICT_EVGDrivers_454_0_5(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
...
static int G___ROOT_DICT_EVGDrivers_454_0_6(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
   char* gvp = (char*) G__getgvp();
   long soff = G__getstructoffset();
   int n = G__getaryconstruct();
...
// automatic assignment operator
static int G___ROOT_DICT_EVGDrivers_454_0_7(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
...
/* genie::GFluxI */
static int G___ROOT_DICT_EVGDrivers_462_0_1(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
      {
...
static int G___ROOT_DICT_EVGDrivers_462_0_2(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
      G__letdouble(result7, 100, (double) ((genie::GFluxI*) G__getstructoffset())->MaxEnergy());
   return(1 || funcname || hash || result7 || libp) ;
}

static int G___ROOT_DICT_EVGDrivers_462_0_3(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
      G__letint(result7, 103, (long) ((genie::GFluxI*) G__getstructoffset())->GenerateNext());
   return(1 || funcname || hash || result7 || libp) ;
}

static int G___ROOT_DICT_EVGDrivers_462_0_4(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
      G__letint(result7, 105, (long) ((genie::GFluxI*) G__getstructoffset())->PdgCode());
   return(1 || funcname || hash || result7 || libp) ;
}

static int G___ROOT_DICT_EVGDrivers_462_0_5(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
      G__letdouble(result7, 100, (double) ((genie::GFluxI*) G__getstructoffset())->Weight());
   return(1 || funcname || hash || result7 || libp) ;
}

static int G___ROOT_DICT_EVGDrivers_462_0_6(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
      {
...
static int G___ROOT_DICT_EVGDrivers_462_0_7(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
      {
...
static int G___ROOT_DICT_EVGDrivers_462_0_8(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
      G__letint(result7, 103, (long) ((genie::GFluxI*) G__getstructoffset())->End());
   return(1 || funcname || hash || result7 || libp) ;
}

static int G___ROOT_DICT_EVGDrivers_462_0_9(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
      G__letint(result7, 108, (long) ((genie::GFluxI*) G__getstructoffset())->Index());
   return(1 || funcname || hash || result7 || libp) ;
}

static int G___ROOT_DICT_EVGDrivers_462_0_10(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
...
static int G___ROOT_DICT_EVGDrivers_462_0_11(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
...
static int G___ROOT_DICT_EVGDrivers_462_0_13(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
   char* gvp = (char*) G__getgvp();
   long soff = G__getstructoffset();
   int n = G__getaryconstruct();
...
// automatic assignment operator
static int G___ROOT_DICT_EVGDrivers_462_0_14(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
...
/* genie::GMCJDriver */
static int G___ROOT_DICT_EVGDrivers_609_0_1(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
...
static int G___ROOT_DICT_EVGDrivers_609_0_2(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
...
static int G___ROOT_DICT_EVGDrivers_609_0_3(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
...
static int G___ROOT_DICT_EVGDrivers_609_0_4(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
...
static int G___ROOT_DICT_EVGDrivers_609_0_5(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
...
static int G___ROOT_DICT_EVGDrivers_609_0_6(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
   switch (libp->paran) {
   case 1:
...
static int G___ROOT_DICT_EVGDrivers_609_0_7(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
      G__letint(result7, 103, (long) ((genie::GMCJDriver*) G__getstructoffset())->UseMaxPathLengths(*((string*) G__int(libp->para[0]))));
   return(1 || funcname || hash || result7 || libp) ;
}

static int G___ROOT_DICT_EVGDrivers_609_0_8(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
...
static int G___ROOT_DICT_EVGDrivers_609_0_9(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
...
static int G___ROOT_DICT_EVGDrivers_609_0_10(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
   switch (libp->paran) {
   case 1:
...
static int G___ROOT_DICT_EVGDrivers_609_0_11(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
      G__letint(result7, 103, (long) ((genie::GMCJDriver*) G__getstructoffset())->PreCalcFluxProbabilities());
   return(1 || funcname || hash || result7 || libp) ;
}

static int G___ROOT_DICT_EVGDrivers_609_0_12(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
      G__letint(result7, 103, (long) ((genie::GMCJDriver*) G__getstructoffset())->LoadFluxProbabilities(*((string*) G__int(libp->para[0]))));
   return(1 || funcname || hash || result7 || libp) ;
}

static int G___ROOT_DICT_EVGDrivers_609_0_13(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
...
static int G___ROOT_DICT_EVGDrivers_609_0_14(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
   switch (libp->paran) {
   case 1:
...
static int G___ROOT_DICT_EVGDrivers_609_0_15(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
      G__letint(result7, 85, (long) ((genie::GMCJDriver*) G__getstructoffset())->GenerateEvent());
   return(1 || funcname || hash || result7 || libp) ;
}

static int G___ROOT_DICT_EVGDrivers_609_0_16(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
      G__letdouble(result7, 100, (double) ((const genie::GMCJDriver*) G__getstructoffset())->GlobProbScale());
   return(1 || funcname || hash || result7 || libp) ;
}

static int G___ROOT_DICT_EVGDrivers_609_0_17(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
      G__letint(result7, 108, (long) ((const genie::GMCJDriver*) G__getstructoffset())->NFluxNeutrinos());
   return(1 || funcname || hash || result7 || libp) ;
}

static int G___ROOT_DICT_EVGDrivers_609_0_18(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
      {
...
static int G___ROOT_DICT_EVGDrivers_609_0_19(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
      {
...
static int G___ROOT_DICT_EVGDrivers_609_0_20(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
      {
...
static int G___ROOT_DICT_EVGDrivers_609_0_21(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
      G__letint(result7, 85, (long) ((const genie::GMCJDriver*) G__getstructoffset())->FluxDriverPtr());
   return(1 || funcname || hash || result7 || libp) ;
}

static int G___ROOT_DICT_EVGDrivers_609_0_22(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
...
// automatic copy constructor
static int G___ROOT_DICT_EVGDrivers_609_0_42(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
...
static int G___ROOT_DICT_EVGDrivers_609_0_43(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
   char* gvp = (char*) G__getgvp();
   long soff = G__getstructoffset();
   int n = G__getaryconstruct();
...
// automatic assignment operator
static int G___ROOT_DICT_EVGDrivers_609_0_44(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
...
/* genie::GMCJMonitor */
static int G___ROOT_DICT_EVGDrivers_618_0_1(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
...
static int G___ROOT_DICT_EVGDrivers_618_0_2(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
...
static int G___ROOT_DICT_EVGDrivers_618_0_3(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
...
// automatic copy constructor
static int G___ROOT_DICT_EVGDrivers_618_0_5(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
...
static int G___ROOT_DICT_EVGDrivers_618_0_6(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
   char* gvp = (char*) G__getgvp();
   long soff = G__getstructoffset();
   int n = G__getaryconstruct();
...
// automatic assignment operator
static int G___ROOT_DICT_EVGDrivers_618_0_7(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
...
static void G__setup_memfuncgeniecLcLGEVGPool(void) {
   ...
   G__memfunc_setup("GEVGPool",707,G___ROOT_DICT_EVGDrivers_454_0_1, 105, G__get_linked_tagnum(&G___ROOT_DICT_EVGDriversLN_geniecLcLGEVGPool), -1, 0, 0, 1, 1, 0, "", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("FindDriver",1005,G___ROOT_DICT_EVGDrivers_454_0_2, 85, G__get_linked_tagnum(&G___ROOT_DICT_EVGDriversLN_geniecLcLGEVGDriver), -1, 0, 1, 1, 1, 8, "u 'genie::InitialState' - 11 - init", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("FindDriver",1005,G___ROOT_DICT_EVGDrivers_454_0_3, 85, G__get_linked_tagnum(&G___ROOT_DICT_EVGDriversLN_geniecLcLGEVGDriver), -1, 0, 1, 1, 1, 8, "u 'string' - 0 - init", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("Print",525,G___ROOT_DICT_EVGDrivers_454_0_4, 121, -1, -1, 0, 1, 1, 1, 8, "u 'basic_ostream<char,char_traits<char> >' 'ostream' 1 - stream", (char*)NULL, (void*) NULL, 0);
   // automatic copy constructor
   G__memfunc_setup("GEVGPool", 707, G___ROOT_DICT_EVGDrivers_454_0_5, (int) ('i'), G__get_linked_tagnum(&G___ROOT_DICT_EVGDriversLN_geniecLcLGEVGPool), -1, 0, 1, 1, 1, 0, "u 'genie::GEVGPool' - 11 - -", (char*) NULL, (void*) NULL, 0);
   // automatic destructor
   G__memfunc_setup("~GEVGPool", 833, G___ROOT_DICT_EVGDrivers_454_0_6, (int) ('y'), -1, -1, 0, 0, 1, 1, 0, "", (char*) NULL, (void*) NULL, 0);
   // automatic assignment operator
   G__memfunc_setup("operator=", 937, G___ROOT_DICT_EVGDrivers_454_0_7, (int) ('u'), G__get_linked_tagnum(&G___ROOT_DICT_EVGDriversLN_geniecLcLGEVGPool), -1, 1, 1, 1, 1, 0, "u 'genie::GEVGPool' - 11 - -", (char*) NULL, (void*) NULL, 0);
   G__tag_memfunc_reset();
}
...
static void G__setup_memfuncgeniecLcLGFluxI(void) {
   ...
   G__memfunc_setup("FluxParticles",1350,G___ROOT_DICT_EVGDrivers_462_0_1, 117, G__get_linked_tagnum(&G___ROOT_DICT_EVGDriversLN_geniecLcLPDGCodeList), -1, 1, 0, 1, 1, 1, "", "/< declare list of flux neutrinos that can be generated (for init. purposes)", (void*) NULL, 3);
   G__memfunc_setup("MaxEnergy",912,G___ROOT_DICT_EVGDrivers_462_0_2, 100, -1, -1, 0, 0, 1, 1, 0, "", "/< declare the max flux neutrino energy that can be generated (for init. purposes)", (void*) NULL, 3);
   G__memfunc_setup("GenerateNext",1226,G___ROOT_DICT_EVGDrivers_462_0_3, 103, -1, -1, 0, 0, 1, 1, 0, "", "/< generate the next flux neutrino (return false in err)", (void*) NULL, 3);
   G__memfunc_setup("PdgCode",662,G___ROOT_DICT_EVGDrivers_462_0_4, 105, -1, -1, 0, 0, 1, 1, 0, "", "/< returns the flux neutrino pdg code", (void*) NULL, 3);
   G__memfunc_setup("Weight",616,G___ROOT_DICT_EVGDrivers_462_0_5, 100, -1, -1, 0, 0, 1, 1, 0, "", "/< returns the flux neutrino weight (if any)", (void*) NULL, 3);
   G__memfunc_setup("Momentum",850,G___ROOT_DICT_EVGDrivers_462_0_6, 117, G__get_linked_tagnum(&G___ROOT_DICT_EVGDriversLN_TLorentzVector), -1, 1, 0, 1, 1, 1, "", "/< returns the flux neutrino 4-momentum ", (void*) NULL, 3);
   G__memfunc_setup("Position",853,G___ROOT_DICT_EVGDrivers_462_0_7, 117, G__get_linked_tagnum(&G___ROOT_DICT_EVGDriversLN_TLorentzVector), -1, 1, 0, 1, 1, 1, "", "/< returns the flux neutrino 4-position (note: expect SI rather than physical units)", (void*) NULL, 3);
   G__memfunc_setup("End",279,G___ROOT_DICT_EVGDrivers_462_0_8, 103, -1, -1, 0, 0, 1, 1, 0, "", "/< true if no more flux nu's can be thrown (eg reaching end of beam sim ntuples)", (void*) NULL, 3);
   G__memfunc_setup("Index",504,G___ROOT_DICT_EVGDrivers_462_0_9, 108, -1, -1, 0, 0, 1, 1, 0, "", "/< returns corresponding index for current flux neutrino (e.g. for a flux ntuple returns the current entry number)", (void*) NULL, 3);
   G__memfunc_setup("Clear",487,G___ROOT_DICT_EVGDrivers_462_0_10, 121, -1, -1, 0, 1, 1, 1, 0, "C - 'Option_t' 10 - opt", "/< reset state variables based on opt", (void*) NULL, 3);
   G__memfunc_setup("GenerateWeighted",1628,G___ROOT_DICT_EVGDrivers_462_0_11, 121, -1, -1, 0, 1, 1, 1, 0, "g - - 0 - gen_weighted", "/< set whether to generate weighted or unweighted neutrinos", (void*) NULL, 3);
   // automatic destructor
   G__memfunc_setup("~GFluxI", 685, G___ROOT_DICT_EVGDrivers_462_0_13, (int) ('y'), -1, -1, 0, 0, 1, 1, 0, "", (char*) NULL, (void*) NULL, 1);
   // automatic assignment operator
   G__memfunc_setup("operator=", 937, G___ROOT_DICT_EVGDrivers_462_0_14, (int) ('u'), G__get_linked_tagnum(&G___ROOT_DICT_EVGDriversLN_geniecLcLGFluxI), -1, 1, 1, 1, 1, 0, "u 'genie::GFluxI' - 11 - -", (char*) NULL, (void*) NULL, 0);
   G__tag_memfunc_reset();
}
...
static void G__setup_memfuncgeniecLcLGMCJDriver(void) {
   ...
   G__memfunc_setup("GMCJDriver",909,G___ROOT_DICT_EVGDrivers_609_0_1, 105, G__get_linked_tagnum(&G___ROOT_DICT_EVGDriversLN_geniecLcLGMCJDriver), -1, 0, 0, 1, 1, 0, "", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("SetEventGeneratorList",2161,G___ROOT_DICT_EVGDrivers_609_0_2, 121, -1, -1, 0, 1, 1, 1, 0, "u 'string' - 0 - listname", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("SetUnphysEventMask",1857,G___ROOT_DICT_EVGDrivers_609_0_3, 121, -1, -1, 0, 1, 1, 1, 0, "u 'TBits' - 11 - mask", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("UseFluxDriver",1336,G___ROOT_DICT_EVGDrivers_609_0_4, 121, -1, -1, 0, 1, 1, 1, 0, "U 'genie::GFluxI' - 0 - flux", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("UseGeomAnalyzer",1531,G___ROOT_DICT_EVGDrivers_609_0_5, 121, -1, -1, 0, 1, 1, 1, 0, "U 'genie::GeomAnalyzerI' - 0 - geom", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("UseSplines",1035,G___ROOT_DICT_EVGDrivers_609_0_6, 121, -1, -1, 0, 1, 1, 1, 0, "g - - 0 'true' useLogE", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("UseMaxPathLengths",1717,G___ROOT_DICT_EVGDrivers_609_0_7, 103, -1, -1, 0, 1, 1, 1, 0, "u 'string' - 0 - xml_filename", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("KeepOnThrowingFluxNeutrinos",2810,G___ROOT_DICT_EVGDrivers_609_0_8, 121, -1, -1, 0, 1, 1, 1, 0, "g - - 0 - keep_on", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("ForceSingleProbScale",1996,G___ROOT_DICT_EVGDrivers_609_0_9, 121, -1, -1, 0, 0, 1, 1, 0, "", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("PreSelectEvents",1532,G___ROOT_DICT_EVGDrivers_609_0_10, 121, -1, -1, 0, 1, 1, 1, 0, "g - - 0 'true' preselect", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("PreCalcFluxProbabilities",2434,G___ROOT_DICT_EVGDrivers_609_0_11, 103, -1, -1, 0, 0, 1, 1, 0, "", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("LoadFluxProbabilities",2152,G___ROOT_DICT_EVGDrivers_609_0_12, 103, -1, -1, 0, 1, 1, 1, 0, "u 'string' - 0 - filename", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("SaveFluxProbabilities",2167,G___ROOT_DICT_EVGDrivers_609_0_13, 121, -1, -1, 0, 1, 1, 1, 0, "u 'string' - 0 - outfilename", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("Configure",930,G___ROOT_DICT_EVGDrivers_609_0_14, 121, -1, -1, 0, 1, 1, 1, 0, "g - - 0 'true' calc_prob_scales", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("GenerateEvent",1325,G___ROOT_DICT_EVGDrivers_609_0_15, 85, G__get_linked_tagnum(&G___ROOT_DICT_EVGDriversLN_geniecLcLEventRecord), -1, 0, 0, 1, 1, 0, "", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("GlobProbScale",1279,G___ROOT_DICT_EVGDrivers_609_0_16, 100, -1, -1, 0, 0, 1, 1, 8, "", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("NFluxNeutrinos",1460,G___ROOT_DICT_EVGDrivers_609_0_17, 108, -1, -1, 0, 0, 1, 1, 8, "", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("SumFluxIntProbs",1541,G___ROOT_DICT_EVGDrivers_609_0_18, 117, G__get_linked_tagnum(&G___ROOT_DICT_EVGDriversLN_maplEintcOdoublecOlesslEintgRcOallocatorlEpairlEconstsPintcOdoublegRsPgRsPgR), G__defined_typename("map<int,double>"), 0, 0, 1, 1, 8, "", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("FluxDriver",1035,G___ROOT_DICT_EVGDrivers_609_0_19, 117, G__get_linked_tagnum(&G___ROOT_DICT_EVGDriversLN_geniecLcLGFluxI), -1, 1, 0, 1, 1, 9, "", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("GeomAnalyzer",1230,G___ROOT_DICT_EVGDrivers_609_0_20, 117, G__get_linked_tagnum(&G___ROOT_DICT_EVGDriversLN_geniecLcLGeomAnalyzerI), -1, 1, 0, 1, 1, 9, "", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("FluxDriverPtr",1345,G___ROOT_DICT_EVGDrivers_609_0_21, 85, G__get_linked_tagnum(&G___ROOT_DICT_EVGDriversLN_geniecLcLGFluxI), -1, 0, 0, 1, 1, 8, "", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("GeomAnalyzerPtr",1540,G___ROOT_DICT_EVGDrivers_609_0_22, 85, G__get_linked_tagnum(&G___ROOT_DICT_EVGDriversLN_geniecLcLGeomAnalyzerI), -1, 0, 0, 1, 1, 8, "", (char*)NULL, (void*) NULL, 0);
...
"i - - 0 - A", (char*)NULL, (void*) NULL, 0);
   ...
   // automatic copy constructor
   G__memfunc_setup("GMCJDriver", 909, G___ROOT_DICT_EVGDrivers_609_0_42, (int) ('i'), G__get_linked_tagnum(&G___ROOT_DICT_EVGDriversLN_geniecLcLGMCJDriver), -1, 0, 1, 1, 1, 0, "u 'genie::GMCJDriver' - 11 - -", (char*) NULL, (void*) NULL, 0);
   // automatic destructor
   G__memfunc_setup("~GMCJDriver", 1035, G___ROOT_DICT_EVGDrivers_609_0_43, (int) ('y'), -1, -1, 0, 0, 1, 1, 0, "", (char*) NULL, (void*) NULL, 0);
   // automatic assignment operator
   G__memfunc_setup("operator=", 937, G___ROOT_DICT_EVGDrivers_609_0_44, (int) ('u'), G__get_linked_tagnum(&G___ROOT_DICT_EVGDriversLN_geniecLcLGMCJDriver), -1, 1, 1, 1, 1, 0, "u 'genie::GMCJDriver' - 11 - -", (char*) NULL, (void*) NULL, 0);
   G__tag_memfunc_reset();
}
...
static void G__setup_memfuncgeniecLcLGMCJMonitor(void) {
   ...
   G__memfunc_setup("GMCJMonitor",1033,G___ROOT_DICT_EVGDrivers_618_0_1, 105, G__get_linked_tagnum(&G___ROOT_DICT_EVGDriversLN_geniecLcLGMCJMonitor), -1, 0, 1, 1, 1, 0, "l - 'Long_t' 0 - runnu", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("SetRefreshRate",1415,G___ROOT_DICT_EVGDrivers_618_0_2, 121, -1, -1, 0, 1, 1, 1, 0, "i - - 0 - rate", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("Update",611,G___ROOT_DICT_EVGDrivers_618_0_3, 121, -1, -1, 0, 2, 1, 1, 0, 
"i - - 0 - iev U 'genie::EventRecord' - 10 - event", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("Init",404,(G__InterfaceMethod) NULL, 121, -1, -1, 0, 0, 1, 4, 0, "", (char*)NULL, (void*) NULL, 0);
   // automatic copy constructor
   G__memfunc_setup("GMCJMonitor", 1033, G___ROOT_DICT_EVGDrivers_618_0_5, (int) ('i'), G__get_linked_tagnum(&G___ROOT_DICT_EVGDriversLN_geniecLcLGMCJMonitor), -1, 0, 1, 1, 1, 0, "u 'genie::GMCJMonitor' - 11 - -", (char*) NULL, (void*) NULL, 0);
   // automatic destructor
   G__memfunc_setup("~GMCJMonitor", 1159, G___ROOT_DICT_EVGDrivers_618_0_6, (int) ('y'), -1, -1, 0, 0, 1, 1, 0, "", (char*) NULL, (void*) NULL, 0);
   // automatic assignment operator
   G__memfunc_setup("operator=", 937, G___ROOT_DICT_EVGDrivers_618_0_7, (int) ('u'), G__get_linked_tagnum(&G___ROOT_DICT_EVGDriversLN_geniecLcLGMCJMonitor), -1, 1, 1, 1, 1, 0, "u 'genie::GMCJMonitor' - 11 - -", (char*) NULL, (void*) NULL, 0);
   G__tag_memfunc_reset();
}
