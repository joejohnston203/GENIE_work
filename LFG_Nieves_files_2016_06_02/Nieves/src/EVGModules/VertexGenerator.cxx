...
/*
 ...
 @ Jun 03, 2016 - JJ (SD)
   Move code to generate the position to another public method, so this code
...
{
// generate a vtx and set it for all GHEP physical particles
  GHepParticle * nucltgt = evrec->TargetNucleus();
  Interaction * interaction = evrec->Summary();
  TVector3 vtx = GenerateVertex(nucltgt,interaction);
...
//____________________________________________________________________________
TVector3 VertexGenerator::GenerateVertex(GHepParticle * nucltgt,
