...
void q2_make_plots() {
  ...
  TString output_file_name = "C12_0.2GeV_Q2_Nieves_RPA_vs_noRPA_LFG";
  // location of .gst.root file from gevgen
  TString rootFile1 = "~/GENIE_work/runs/2016_05_21/2016_05_21_C12_0.2GeV_N_noRPA_noCoul_LFG/numu_C12_CCQE_run0.gst.root";
  ...
  TString rootFile2 = "~/GENIE_work/runs/2016_05_21/2016_05_21_C12_0.2GeV_N_RPA_Coul_LFG/numu_C12_CCQE_run0.gst.root";
  ...
  double xmax = 0.2;
  double ymax = 13.0; // y axis max for plot where all solid angles are integrated
