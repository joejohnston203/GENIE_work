...
function compare_tensors_choose_kine() {
    ...
    autoGNUPlot "$files" 'pc_'$3'_q2_imU.png' 1 13 'Q2' 'imU' 'Q2 vs imU'
    ...
    autoGNUPlot "$files" 'ff_'$3'_q2_fa.png' 1 16 'Q2' 'fa' 'Q2 vs fa'
    autoGNUPlot "$files" 'ff_'$3'_q2_fp.png' 1 17 'Q2' 'fp' 'Q2 vs fp'
