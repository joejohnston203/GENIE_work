...
void dsigmadTl_make_plots() {
  ...
  TString output_file_name = "N_RPA_Coul_LFG_Pb208_0.2GeV";
  // location of .gst.root file from gevgen
  TString rootFile = "~/GENIE_work/nieves_validation/dsigmadTl_validation/2016_06_02_Pb208_0.2GeV_N_RPA_Coul_LFG/numu_Pb208_CCQE_run0.gst.root";
  // 2 column text file (as above) or .root spline file
  TString spline = "~/GENIE_work/nieves_validation/dsigmadTl_validation/2016_06_02_Pb208_0.2GeV_N_RPA_Coul_LFG/data_2016_06_02_Pb208_0.2GeV_N_RPA_Coul_LFG.txt";
