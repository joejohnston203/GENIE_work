...
void dsigmadTl_make_plots() {
  ...
  TString output_file_name = "N_noRPA_noCoul_LFG_Pb208_1GeV";
  // location of .gst.root file from gevgen
  TString rootFile = "~/GENIE_work/nieves_validation/dsigmadTl_validation/2016_06_02_Pb208_1.0GeV_N_noRPA_noCoul_LFG/numu_Pb208_CCQE_run0.gst.root";
  // 2 column text file (as above) or .root spline file
  TString spline = "~/GENIE_work/nieves_validation/dsigmadTl_validation/2016_06_02_Pb208_1.0GeV_N_noRPA_noCoul_LFG/data_2016_06_02_Pb208_1.0GeV_N_noRPA_noCoul_LFG.txt";
  ...
  double ymax2 = 200.0; // y axis max for plot with specific ctl values
