...
void dsigmadTl_make_plots() {
  ...
  TString output_file_name = "N_noRPA_noCoul_LFG_Pb208_0.2GeV";
  // location of .gst.root file from gevgen
  TString rootFile = "~/GENIE_work/nieves_validation/dsigmadTl_validation/2016_06_02_Pb208_0.2GeV_N_noRPA_noCoul_LFG/numu_Pb208_CCQE_run0.gst.root";
  // 2 column text file (as above) or .root spline file
  TString spline = "~/GENIE_work/nieves_validation/dsigmadTl_validation/2016_06_02_Pb208_0.2GeV_N_noRPA_noCoul_LFG/data_2016_06_02_Pb208_0.2GeV_N_noRPA_noCoul_LFG.txt";
  ...
  TString target = "Pb208"; // C12 or Pb208
  TString Enu = "0.2"; // in GeV- 0.2, 1.0, or 5.0 
  TString RPA = "0";   // 0 or 1
  TString Coul = "0";  // 0 or 1
  double ymax1 = 800.0; // y axis max for plot where all solid angles are integrated
  double ymax2 = 50.0; // y axis max for plot with specific ctl values
