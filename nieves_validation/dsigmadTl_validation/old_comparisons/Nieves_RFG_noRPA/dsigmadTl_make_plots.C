...
void dsigmadTl_make_plots() {
  ...
  TString output_file_name = "Nieves_RFG_noRPA_1GeV_C12";
  // location of .gst.root file from gevgen
  TString rootFile = "~/GENIE_work/runs/2016_05_12_Nieves_RFG_noRPA_noCoul_1mil/numu_C12_CCQE_run0.gst.root";
