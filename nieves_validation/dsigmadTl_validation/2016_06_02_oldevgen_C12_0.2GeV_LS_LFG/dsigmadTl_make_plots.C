...
void dsigmadTl_make_plots() {
  ...
  TString output_file_name = "LS_LFG_C12_0.2GeV_oldevgen";
  // location of .gst.root file from gevgen
  TString rootFile = "~/GENIE_work/nieves_validation/dsigmadTl_validation/2016_06_02_oldevgen_C12_0.2GeV_LS_LFG/numu_C12_CCQE_run0.gst.root";
  // 2 column text file (as above) or .root spline file
  TString spline = "~/GENIE_work/nieves_validation/dsigmadTl_validation/2016_06_02_oldevgen_C12_0.2GeV_LS_LFG/data_2016_06_02_oldevgen_C12_0.2GeV_LS_LFG.txt";
