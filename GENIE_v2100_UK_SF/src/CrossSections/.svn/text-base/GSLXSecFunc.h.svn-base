...
///.....................................................................................
/// 
/// fullDifferentialXSec - testing SF CCQE xsec calculation with angular cut for eA (also used for nuA)
class fullDifferentialXSec: public ROOT::Math::IBaseFunctionMultiDim // name is temporary
{
  public:
    fullDifferentialXSec(const XSecAlgorithmI * m, const Interaction * i);
  ...
  private:
//    const ROOT::Math::IBaseFunctionMultiDim * fFn; // don't think we need this
    const XSecAlgorithmI * fModel;
    const Interaction *    fInteraction;
};
