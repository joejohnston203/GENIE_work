//
// File generated by rootcint at Mon Apr 11 14:46:39 2016
   ...
   static TGenericClassInfo *GenerateInitInstanceLocal(const ::genie::BLI2DGrid*)
   {
      ...
      static ::ROOT::TGenericClassInfo 
         instance("genie::BLI2DGrid", ::genie::BLI2DGrid::Class_Version(), "./BLI2D.h", 26,
                  typeid(::genie::BLI2DGrid), DefineBehavior(ptr, ptr),
   ...
   static TGenericClassInfo *GenerateInitInstanceLocal(const ::genie::BLI2DUnifGrid*)
   {
      ...
      static ::ROOT::TGenericClassInfo 
         instance("genie::BLI2DUnifGrid", ::genie::BLI2DUnifGrid::Class_Version(), "./BLI2D.h", 76,
                  typeid(::genie::BLI2DUnifGrid), DefineBehavior(ptr, ptr),
   ...
   static TGenericClassInfo *GenerateInitInstanceLocal(const ::genie::BLI2DNonUnifGrid*)
   {
      ...
      static ::ROOT::TGenericClassInfo 
         instance("genie::BLI2DNonUnifGrid", ::genie::BLI2DNonUnifGrid::Class_Version(), "./BLI2D.h", 100,
                  typeid(::genie::BLI2DNonUnifGrid), DefineBehavior(ptr, ptr),
...
namespace ROOT {
   ...
   static TGenericClassInfo *GenerateInitInstanceLocal(const ::genie::RandomGen*)
   {
      ...
      static ::ROOT::TGenericClassInfo 
         instance("genie::RandomGen", "./RandomGen.h", 30,
                  typeid(::genie::RandomGen), DefineBehavior(ptr, ptr),
   ...
   // Dictionary for non-ClassDef classes
   static void geniecLcLRandomGen_Dictionary() {
      ::ROOT::GenerateInitInstanceLocal((const ::genie::RandomGen*)0x0)->GetClass();
   }
   ...
   static TGenericClassInfo *GenerateInitInstanceLocal(const ::genie::Spline*)
   {
      ...
      static ::ROOT::TGenericClassInfo 
         instance("genie::Spline", ::genie::Spline::Class_Version(), "./Spline.h", 44,
                  typeid(::genie::Spline), DefineBehavior(ptr, ptr),
...
TClass *BLI2DGrid::fgIsA = 0;  // static to hold class pointer
...
{
   if (!fgIsA) fgIsA = ::ROOT::GenerateInitInstanceLocal((const ::genie::BLI2DGrid*)0x0)->GetClass();
   return fgIsA;
}
      ...
      namespace genie {
//______________________________________________________________________________
TClass *BLI2DUnifGrid::fgIsA = 0;  // static to hold class pointer
...
{
   if (!fgIsA) fgIsA = ::ROOT::GenerateInitInstanceLocal((const ::genie::BLI2DUnifGrid*)0x0)->GetClass();
   return fgIsA;
}
      ...
      namespace genie {
//______________________________________________________________________________
TClass *BLI2DNonUnifGrid::fgIsA = 0;  // static to hold class pointer
...
{
   if (!fgIsA) fgIsA = ::ROOT::GenerateInitInstanceLocal((const ::genie::BLI2DNonUnifGrid*)0x0)->GetClass();
   return fgIsA;
}
      ...
      namespace genie {
//______________________________________________________________________________
TClass *Spline::fgIsA = 0;  // static to hold class pointer
...
TClass *Spline::Class()
{
   if (!fgIsA) fgIsA = ::ROOT::GenerateInitInstanceLocal((const ::genie::Spline*)0x0)->GetClass();
   return fgIsA;
}
...
/* genie::RandomGen */
static int G___ROOT_DICT_Numerical_189_0_1(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
      G__letint(result7, 85, (long) genie::RandomGen::Instance());
   return(1 || funcname || hash || result7 || libp) ;
}

static int G___ROOT_DICT_Numerical_189_0_2(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
      {
...
static int G___ROOT_DICT_Numerical_189_0_3(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
      {
...
static int G___ROOT_DICT_Numerical_189_0_4(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
      {
...
static int G___ROOT_DICT_Numerical_189_0_5(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
      {
...
static int G___ROOT_DICT_Numerical_189_0_6(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
      {
...
static int G___ROOT_DICT_Numerical_189_0_7(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
      {
...
static int G___ROOT_DICT_Numerical_189_0_8(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
      {
...
static int G___ROOT_DICT_Numerical_189_0_9(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
      {
...
static int G___ROOT_DICT_Numerical_189_0_10(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
      {
...
static int G___ROOT_DICT_Numerical_189_0_11(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
      {
...
static int G___ROOT_DICT_Numerical_189_0_12(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
      {
...
static int G___ROOT_DICT_Numerical_189_0_13(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
      G__letint(result7, 108, (long) ((const genie::RandomGen*) G__getstructoffset())->GetSeed());
   return(1 || funcname || hash || result7 || libp) ;
}

static int G___ROOT_DICT_Numerical_189_0_14(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
...
// automatic assignment operator
static int G___ROOT_DICT_Numerical_189_0_18(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
...
/* genie::Spline */
static int G___ROOT_DICT_Numerical_216_0_1(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
   genie::Spline* p = NULL;
   char* gvp = (char*) G__getgvp();
   int n = G__getaryconstruct();
...
static int G___ROOT_DICT_Numerical_216_0_2(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
   genie::Spline* p = NULL;
   char* gvp = (char*) G__getgvp();
   switch (libp->paran) {
...
static int G___ROOT_DICT_Numerical_216_0_3(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
   genie::Spline* p = NULL;
   char* gvp = (char*) G__getgvp();
   switch (libp->paran) {
...
static int G___ROOT_DICT_Numerical_216_0_4(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
   genie::Spline* p = NULL;
   char* gvp = (char*) G__getgvp();
   switch (libp->paran) {
...
static int G___ROOT_DICT_Numerical_216_0_5(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
   genie::Spline* p = NULL;
   char* gvp = (char*) G__getgvp();
   //m: 2
...
static int G___ROOT_DICT_Numerical_216_0_6(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
   genie::Spline* p = NULL;
   char* gvp = (char*) G__getgvp();
   //m: 3
...
static int G___ROOT_DICT_Numerical_216_0_7(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
   genie::Spline* p = NULL;
   char* gvp = (char*) G__getgvp();
   //m: 3
...
static int G___ROOT_DICT_Numerical_216_0_8(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
   genie::Spline* p = NULL;
   char* gvp = (char*) G__getgvp();
   //m: 1
...
static int G___ROOT_DICT_Numerical_216_0_9(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
   genie::Spline* p = NULL;
   char* gvp = (char*) G__getgvp();
   //m: 2
...
static int G___ROOT_DICT_Numerical_216_0_10(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
...
static int G___ROOT_DICT_Numerical_216_0_11(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
      G__letint(result7, 103, (long) ((genie::Spline*) G__getstructoffset())->LoadFromAsciiFile(*((string*) G__int(libp->para[0]))));
   return(1 || funcname || hash || result7 || libp) ;
}

static int G___ROOT_DICT_Numerical_216_0_12(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
   switch (libp->paran) {
   case 3:
...
static int G___ROOT_DICT_Numerical_216_0_13(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
   switch (libp->paran) {
   case 3:
...
static int G___ROOT_DICT_Numerical_216_0_14(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
...
static int G___ROOT_DICT_Numerical_216_0_15(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
...
static int G___ROOT_DICT_Numerical_216_0_16(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
      G__letint(result7, 105, (long) ((const genie::Spline*) G__getstructoffset())->NKnots());
   return(1 || funcname || hash || result7 || libp) ;
}

static int G___ROOT_DICT_Numerical_216_0_17(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
...
static int G___ROOT_DICT_Numerical_216_0_18(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
      G__letdouble(result7, 100, (double) ((const genie::Spline*) G__getstructoffset())->GetKnotX((int) G__int(libp->para[0])));
   return(1 || funcname || hash || result7 || libp) ;
}

static int G___ROOT_DICT_Numerical_216_0_19(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
      G__letdouble(result7, 100, (double) ((const genie::Spline*) G__getstructoffset())->GetKnotY((int) G__int(libp->para[0])));
   return(1 || funcname || hash || result7 || libp) ;
}

static int G___ROOT_DICT_Numerical_216_0_20(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
      G__letdouble(result7, 100, (double) ((const genie::Spline*) G__getstructoffset())->XMin());
   return(1 || funcname || hash || result7 || libp) ;
}

static int G___ROOT_DICT_Numerical_216_0_21(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
      G__letdouble(result7, 100, (double) ((const genie::Spline*) G__getstructoffset())->XMax());
   return(1 || funcname || hash || result7 || libp) ;
}

static int G___ROOT_DICT_Numerical_216_0_22(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
      G__letdouble(result7, 100, (double) ((const genie::Spline*) G__getstructoffset())->YMax());
   return(1 || funcname || hash || result7 || libp) ;
}

static int G___ROOT_DICT_Numerical_216_0_23(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
      G__letdouble(result7, 100, (double) ((const genie::Spline*) G__getstructoffset())->Evaluate((double) G__double(libp->para[0])));
   return(1 || funcname || hash || result7 || libp) ;
}

static int G___ROOT_DICT_Numerical_216_0_24(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
      G__letint(result7, 103, (long) ((const genie::Spline*) G__getstructoffset())->IsWithinValidRange((double) G__double(libp->para[0])));
   return(1 || funcname || hash || result7 || libp) ;
}

static int G___ROOT_DICT_Numerical_216_0_25(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
...
static int G___ROOT_DICT_Numerical_216_0_26(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
      {
         const string* pobj;
...
static int G___ROOT_DICT_Numerical_216_0_27(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
...
static int G___ROOT_DICT_Numerical_216_0_28(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
   switch (libp->paran) {
   case 4:
...
static int G___ROOT_DICT_Numerical_216_0_29(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
   switch (libp->paran) {
   case 5:
...
static int G___ROOT_DICT_Numerical_216_0_30(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
   switch (libp->paran) {
   case 2:
...
static int G___ROOT_DICT_Numerical_216_0_31(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
   switch (libp->paran) {
   case 3:
...
static int G___ROOT_DICT_Numerical_216_0_32(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
   switch (libp->paran) {
   case 5:
...
static int G___ROOT_DICT_Numerical_216_0_33(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
      G__letint(result7, 85, (long) ((const genie::Spline*) G__getstructoffset())->GetAsTSpline());
   return(1 || funcname || hash || result7 || libp) ;
}

static int G___ROOT_DICT_Numerical_216_0_34(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
   switch (libp->paran) {
   case 4:
...
static int G___ROOT_DICT_Numerical_216_0_35(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
   switch (libp->paran) {
   case 2:
...
static int G___ROOT_DICT_Numerical_216_0_36(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
   switch (libp->paran) {
   case 2:
...
static int G___ROOT_DICT_Numerical_216_0_37(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
   switch (libp->paran) {
   case 2:
...
static int G___ROOT_DICT_Numerical_216_0_38(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
   switch (libp->paran) {
   case 2:
...
static int G___ROOT_DICT_Numerical_216_0_39(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
...
static int G___ROOT_DICT_Numerical_216_0_40(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
...
static int G___ROOT_DICT_Numerical_216_0_41(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
...
static int G___ROOT_DICT_Numerical_216_0_42(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
...
static int G___ROOT_DICT_Numerical_216_0_46(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
      G__letint(result7, 85, (long) genie::Spline::Class());
   return(1 || funcname || hash || result7 || libp) ;
}

static int G___ROOT_DICT_Numerical_216_0_47(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
      G__letint(result7, 67, (long) genie::Spline::Class_Name());
   return(1 || funcname || hash || result7 || libp) ;
}

static int G___ROOT_DICT_Numerical_216_0_48(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
      G__letint(result7, 115, (long) genie::Spline::Class_Version());
   return(1 || funcname || hash || result7 || libp) ;
}

static int G___ROOT_DICT_Numerical_216_0_49(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
...
static int G___ROOT_DICT_Numerical_216_0_53(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
...
static int G___ROOT_DICT_Numerical_216_0_54(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
      G__letint(result7, 67, (long) genie::Spline::DeclFileName());
   return(1 || funcname || hash || result7 || libp) ;
}

static int G___ROOT_DICT_Numerical_216_0_55(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
      G__letint(result7, 105, (long) genie::Spline::ImplFileLine());
   return(1 || funcname || hash || result7 || libp) ;
}

static int G___ROOT_DICT_Numerical_216_0_56(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
      G__letint(result7, 67, (long) genie::Spline::ImplFileName());
   return(1 || funcname || hash || result7 || libp) ;
}

static int G___ROOT_DICT_Numerical_216_0_57(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
...
static int G___ROOT_DICT_Numerical_216_0_58(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
   char* gvp = (char*) G__getgvp();
   long soff = G__getstructoffset();
   int n = G__getaryconstruct();
...
// automatic assignment operator
static int G___ROOT_DICT_Numerical_216_0_59(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
...
static void G__setup_memvargeniecLcLBLI2DGrid(void) {
   ...
   G__memvar_setup((void*)0,85,0,0,G__get_linked_tagnum(&G___ROOT_DICT_NumericalLN_TClass),-1,-2,4,"fgIsA=",0,(char*)NULL);
   }
   G__tag_memvar_reset();
}
...
static void G__setup_memfuncgeniecLcLRandomGen(void) {
   ...
   G__memfunc_setup("Instance",821,G___ROOT_DICT_Numerical_189_0_1, 85, G__get_linked_tagnum(&G___ROOT_DICT_NumericalLN_geniecLcLRandomGen), -1, 0, 0, 3, 1, 0, "", (char*)NULL, (void*) G__func2void( (genie::RandomGen* (*)())(&genie::RandomGen::Instance) ), 0);
   G__memfunc_setup("RndKine",683,G___ROOT_DICT_Numerical_189_0_2, 117, G__get_linked_tagnum(&G___ROOT_DICT_NumericalLN_TRandom3), -1, 1, 0, 1, 1, 8, "", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("RndHadro",786,G___ROOT_DICT_Numerical_189_0_3, 117, G__get_linked_tagnum(&G___ROOT_DICT_NumericalLN_TRandom3), -1, 1, 0, 1, 1, 8, "", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("RndDec",560,G___ROOT_DICT_Numerical_189_0_4, 117, G__get_linked_tagnum(&G___ROOT_DICT_NumericalLN_TRandom3), -1, 1, 0, 1, 1, 8, "", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("RndFsi",582,G___ROOT_DICT_Numerical_189_0_5, 117, G__get_linked_tagnum(&G___ROOT_DICT_NumericalLN_TRandom3), -1, 1, 0, 1, 1, 8, "", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("RndLep",581,G___ROOT_DICT_Numerical_189_0_6, 117, G__get_linked_tagnum(&G___ROOT_DICT_NumericalLN_TRandom3), -1, 1, 0, 1, 1, 8, "", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("RndISel",657,G___ROOT_DICT_Numerical_189_0_7, 117, G__get_linked_tagnum(&G___ROOT_DICT_NumericalLN_TRandom3), -1, 1, 0, 1, 1, 8, "", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("RndGeom",684,G___ROOT_DICT_Numerical_189_0_8, 117, G__get_linked_tagnum(&G___ROOT_DICT_NumericalLN_TRandom3), -1, 1, 0, 1, 1, 8, "", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("RndFlux",707,G___ROOT_DICT_Numerical_189_0_9, 117, G__get_linked_tagnum(&G___ROOT_DICT_NumericalLN_TRandom3), -1, 1, 0, 1, 1, 8, "", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("RndEvg",582,G___ROOT_DICT_Numerical_189_0_10, 117, G__get_linked_tagnum(&G___ROOT_DICT_NumericalLN_TRandom3), -1, 1, 0, 1, 1, 8, "", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("RndNum",596,G___ROOT_DICT_Numerical_189_0_11, 117, G__get_linked_tagnum(&G___ROOT_DICT_NumericalLN_TRandom3), -1, 1, 0, 1, 1, 8, "", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("RndGen",574,G___ROOT_DICT_Numerical_189_0_12, 117, G__get_linked_tagnum(&G___ROOT_DICT_NumericalLN_TRandom3), -1, 1, 0, 1, 1, 8, "", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("GetSeed",673,G___ROOT_DICT_Numerical_189_0_13, 108, -1, -1, 0, 0, 1, 1, 8, "", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("SetSeed",685,G___ROOT_DICT_Numerical_189_0_14, 121, -1, -1, 0, 1, 1, 1, 0, "l - - 0 - seed", (char*)NULL, (void*) NULL, 0);
   ...
   // automatic assignment operator
   G__memfunc_setup("operator=", 937, G___ROOT_DICT_Numerical_189_0_18, (int) ('u'), G__get_linked_tagnum(&G___ROOT_DICT_NumericalLN_geniecLcLRandomGen), -1, 1, 1, 1, 1, 0, "u 'genie::RandomGen' - 11 - -", (char*) NULL, (void*) NULL, 0);
   G__tag_memfunc_reset();
}
...
static void G__setup_memfuncgeniecLcLSpline(void) {
   ...
   G__memfunc_setup("Spline",619,G___ROOT_DICT_Numerical_216_0_1, 105, G__get_linked_tagnum(&G___ROOT_DICT_NumericalLN_geniecLcLSpline), -1, 0, 0, 1, 1, 0, "", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("Spline",619,G___ROOT_DICT_Numerical_216_0_2, 105, G__get_linked_tagnum(&G___ROOT_DICT_NumericalLN_geniecLcLSpline), -1, 0, 4, 1, 1, 0, 
"u 'string' - 0 - filename u 'string' - 0 '\"\"' xtag "
"u 'string' - 0 '\"\"' ytag g - - 0 'false' is_xml", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("Spline",619,G___ROOT_DICT_Numerical_216_0_3, 105, G__get_linked_tagnum(&G___ROOT_DICT_NumericalLN_geniecLcLSpline), -1, 0, 3, 1, 1, 0, 
"U 'TNtupleD' - 0 - ntuple u 'string' - 0 - xy "
"u 'string' - 0 '\"\"' cut", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("Spline",619,G___ROOT_DICT_Numerical_216_0_4, 105, G__get_linked_tagnum(&G___ROOT_DICT_NumericalLN_geniecLcLSpline), -1, 0, 3, 1, 1, 0, 
"U 'TTree' - 0 - tree u 'string' - 0 - xy "
"u 'string' - 0 '\"\"' cut", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("Spline",619,G___ROOT_DICT_Numerical_216_0_5, 105, G__get_linked_tagnum(&G___ROOT_DICT_NumericalLN_geniecLcLSpline), -1, 0, 2, 1, 1, 0, 
"U 'TSQLServer' - 0 - db u 'string' - 0 - query", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("Spline",619,G___ROOT_DICT_Numerical_216_0_6, 105, G__get_linked_tagnum(&G___ROOT_DICT_NumericalLN_geniecLcLSpline), -1, 0, 3, 1, 1, 0, 
"i - - 0 - nentries D - - 0 - x "
"D - - 0 - y", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("Spline",619,G___ROOT_DICT_Numerical_216_0_7, 105, G__get_linked_tagnum(&G___ROOT_DICT_NumericalLN_geniecLcLSpline), -1, 0, 3, 1, 1, 0, 
"i - - 0 - nentries F - - 0 - x "
"F - - 0 - y", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("Spline",619,G___ROOT_DICT_Numerical_216_0_8, 105, G__get_linked_tagnum(&G___ROOT_DICT_NumericalLN_geniecLcLSpline), -1, 0, 1, 1, 1, 0, "u 'genie::Spline' - 11 - spline", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("Spline",619,G___ROOT_DICT_Numerical_216_0_9, 105, G__get_linked_tagnum(&G___ROOT_DICT_NumericalLN_geniecLcLSpline), -1, 0, 2, 1, 1, 0, 
"u 'TSpline3' - 11 - spline i - - 0 - nknots", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("LoadFromXmlFile",1477,G___ROOT_DICT_Numerical_216_0_10, 103, -1, -1, 0, 3, 1, 1, 0, 
"u 'string' - 0 - filename u 'string' - 0 - xtag "
"u 'string' - 0 - ytag", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("LoadFromAsciiFile",1661,G___ROOT_DICT_Numerical_216_0_11, 103, -1, -1, 0, 1, 1, 1, 0, "u 'string' - 0 - filename", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("LoadFromNtuple",1420,G___ROOT_DICT_Numerical_216_0_12, 103, -1, -1, 0, 3, 1, 1, 0, 
"U 'TNtupleD' - 0 - nt u 'string' - 0 - xy "
"u 'string' - 0 '\"\"' cut", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("LoadFromTree",1188,G___ROOT_DICT_Numerical_216_0_13, 103, -1, -1, 0, 3, 1, 1, 0, 
"U 'TTree' - 0 - tr u 'string' - 0 - xy "
"u 'string' - 0 '\"\"' cut", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("LoadFromDBase",1235,G___ROOT_DICT_Numerical_216_0_14, 103, -1, -1, 0, 2, 1, 1, 0, 
"U 'TSQLServer' - 0 - db u 'string' - 0 - query", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("LoadFromTSpline3",1542,G___ROOT_DICT_Numerical_216_0_15, 103, -1, -1, 0, 2, 1, 1, 0, 
"u 'TSpline3' - 11 - spline i - - 0 - nknots", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("NKnots",605,G___ROOT_DICT_Numerical_216_0_16, 105, -1, -1, 0, 0, 1, 1, 8, "", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("GetKnot",700,G___ROOT_DICT_Numerical_216_0_17, 121, -1, -1, 0, 3, 1, 1, 8, 
"i - - 0 - iknot d - - 1 - x "
"d - - 1 - y", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("GetKnotX",788,G___ROOT_DICT_Numerical_216_0_18, 100, -1, -1, 0, 1, 1, 1, 8, "i - - 0 - iknot", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("GetKnotY",789,G___ROOT_DICT_Numerical_216_0_19, 100, -1, -1, 0, 1, 1, 1, 8, "i - - 0 - iknot", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("XMin",380,G___ROOT_DICT_Numerical_216_0_20, 100, -1, -1, 0, 0, 1, 1, 8, "", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("XMax",382,G___ROOT_DICT_Numerical_216_0_21, 100, -1, -1, 0, 0, 1, 1, 8, "", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("YMax",383,G___ROOT_DICT_Numerical_216_0_22, 100, -1, -1, 0, 0, 1, 1, 8, "", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("Evaluate",823,G___ROOT_DICT_Numerical_216_0_23, 100, -1, -1, 0, 1, 1, 1, 8, "d - - 0 - x", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("IsWithinValidRange",1804,G___ROOT_DICT_Numerical_216_0_24, 103, -1, -1, 0, 1, 1, 1, 8, "d - - 0 - x", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("SetName",685,G___ROOT_DICT_Numerical_216_0_25, 121, -1, -1, 0, 1, 1, 1, 0, "u 'string' - 0 - name", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("Name",385,G___ROOT_DICT_Numerical_216_0_26, 117, G__get_linked_tagnum(&G___ROOT_DICT_NumericalLN_string), -1, 0, 0, 1, 1, 8, "", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("YCanBeNegative",1349,G___ROOT_DICT_Numerical_216_0_27, 121, -1, -1, 0, 1, 1, 1, 0, "g - - 0 - tf", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("SaveAsXml",884,G___ROOT_DICT_Numerical_216_0_28, 121, -1, -1, 0, 4, 1, 1, 8, 
"u 'string' - 0 - filename u 'string' - 0 - xtag "
"u 'string' - 0 - ytag u 'string' - 0 '\"\"' name", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("SaveAsXml",884,G___ROOT_DICT_Numerical_216_0_29, 121, -1, -1, 0, 5, 1, 1, 8, 
...
"g - - 0 'false' insert", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("SaveAsText",1000,G___ROOT_DICT_Numerical_216_0_30, 121, -1, -1, 0, 2, 1, 1, 8, 
"u 'string' - 0 - filename u 'string' - 0 '\"%10.6f\\t%10.6f\"' format", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("SaveAsROOT",903,G___ROOT_DICT_Numerical_216_0_31, 121, -1, -1, 0, 3, 1, 1, 8, 
"u 'string' - 0 - filename u 'string' - 0 '\"\"' name "
"g - - 0 'false' recreate", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("GetAsTGraph",1050,G___ROOT_DICT_Numerical_216_0_32, 85, G__get_linked_tagnum(&G___ROOT_DICT_NumericalLN_TGraph), -1, 0, 5, 1, 1, 8, 
"i - - 0 '500' np g - - 0 'false' xscaling "
"g - - 0 'false' inlog d - - 0 '1.' fx "
"d - - 0 '1.' fy", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("GetAsTSpline",1171,G___ROOT_DICT_Numerical_216_0_33, 85, G__get_linked_tagnum(&G___ROOT_DICT_NumericalLN_TSpline3), -1, 0, 0, 1, 1, 8, "", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("FindClosestKnot",1530,G___ROOT_DICT_Numerical_216_0_34, 121, -1, -1, 0, 4, 1, 1, 8, 
"d - - 0 - x d - - 1 - xknot "
"d - - 1 - yknot C - 'Option_t' 10 '\"-+\"' opt", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("ClosestKnotValueIsZero",2258,G___ROOT_DICT_Numerical_216_0_35, 103, -1, -1, 0, 2, 1, 1, 8, 
"d - - 0 - x C - 'Option_t' 10 '\"-+\"' opt", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("Add",265,G___ROOT_DICT_Numerical_216_0_36, 121, -1, -1, 0, 2, 1, 1, 0, 
"u 'genie::Spline' - 11 - spl d - - 0 '1' c", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("Multiply",864,G___ROOT_DICT_Numerical_216_0_37, 121, -1, -1, 0, 2, 1, 1, 0, 
"u 'genie::Spline' - 11 - spl d - - 0 '1' c", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("Divide",597,G___ROOT_DICT_Numerical_216_0_38, 121, -1, -1, 0, 2, 1, 1, 0, 
"u 'genie::Spline' - 11 - spl d - - 0 '1' c", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("Add",265,G___ROOT_DICT_Numerical_216_0_39, 121, -1, -1, 0, 1, 1, 1, 0, "d - - 0 - a", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("Multiply",864,G___ROOT_DICT_Numerical_216_0_40, 121, -1, -1, 0, 1, 1, 1, 0, "d - - 0 - a", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("Divide",597,G___ROOT_DICT_Numerical_216_0_41, 121, -1, -1, 0, 1, 1, 1, 0, "d - - 0 - a", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("Print",525,G___ROOT_DICT_Numerical_216_0_42, 121, -1, -1, 0, 1, 1, 1, 8, "u 'basic_ostream<char,char_traits<char> >' 'ostream' 1 - stream", (char*)NULL, (void*) NULL, 0);
...
"i - - 0 - nentries D - - 0 - x "
"D - - 0 - y", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("Class",502,G___ROOT_DICT_Numerical_216_0_46, 85, G__get_linked_tagnum(&G___ROOT_DICT_NumericalLN_TClass), -1, 0, 0, 3, 1, 0, "", (char*)NULL, (void*) G__func2void( (TClass* (*)())(&genie::Spline::Class) ), 0);
   G__memfunc_setup("Class_Name",982,G___ROOT_DICT_Numerical_216_0_47, 67, -1, -1, 0, 0, 3, 1, 1, "", (char*)NULL, (void*) G__func2void( (const char* (*)())(&genie::Spline::Class_Name) ), 0);
   G__memfunc_setup("Class_Version",1339,G___ROOT_DICT_Numerical_216_0_48, 115, -1, G__defined_typename("Version_t"), 0, 0, 3, 1, 0, "", (char*)NULL, (void*) G__func2void( (Version_t (*)())(&genie::Spline::Class_Version) ), 0);
   G__memfunc_setup("Dictionary",1046,G___ROOT_DICT_Numerical_216_0_49, 121, -1, -1, 0, 0, 3, 1, 0, "", (char*)NULL, (void*) G__func2void( (void (*)())(&genie::Spline::Dictionary) ), 0);
   G__memfunc_setup("IsA",253,(G__InterfaceMethod) NULL,85, G__get_linked_tagnum(&G___ROOT_DICT_NumericalLN_TClass), -1, 0, 0, 1, 1, 8, "", (char*)NULL, (void*) NULL, 1);
   G__memfunc_setup("ShowMembers",1132,(G__InterfaceMethod) NULL,121, -1, -1, 0, 1, 1, 1, 0, "u 'TMemberInspector' - 1 - -", (char*)NULL, (void*) NULL, 1);
   G__memfunc_setup("Streamer",835,(G__InterfaceMethod) NULL,121, -1, -1, 0, 1, 1, 1, 0, "u 'TBuffer' - 1 - -", (char*)NULL, (void*) NULL, 1);
   G__memfunc_setup("StreamerNVirtual",1656,G___ROOT_DICT_Numerical_216_0_53, 121, -1, -1, 0, 1, 1, 1, 0, "u 'TBuffer' - 1 - ClassDef_StreamerNVirtual_b", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("DeclFileName",1145,G___ROOT_DICT_Numerical_216_0_54, 67, -1, -1, 0, 0, 3, 1, 1, "", (char*)NULL, (void*) G__func2void( (const char* (*)())(&genie::Spline::DeclFileName) ), 0);
   G__memfunc_setup("ImplFileLine",1178,G___ROOT_DICT_Numerical_216_0_55, 105, -1, -1, 0, 0, 3, 1, 0, "", (char*)NULL, (void*) G__func2void( (int (*)())(&genie::Spline::ImplFileLine) ), 0);
   G__memfunc_setup("ImplFileName",1171,G___ROOT_DICT_Numerical_216_0_56, 67, -1, -1, 0, 0, 3, 1, 1, "", (char*)NULL, (void*) G__func2void( (const char* (*)())(&genie::Spline::ImplFileName) ), 0);
   G__memfunc_setup("DeclFileLine",1152,G___ROOT_DICT_Numerical_216_0_57, 105, -1, -1, 0, 0, 3, 1, 0, "", (char*)NULL, (void*) G__func2void( (int (*)())(&genie::Spline::DeclFileLine) ), 0);
   // automatic destructor
   G__memfunc_setup("~Spline", 745, G___ROOT_DICT_Numerical_216_0_58, (int) ('y'), -1, -1, 0, 0, 1, 1, 0, "", (char*) NULL, (void*) NULL, 1);
   // automatic assignment operator
   G__memfunc_setup("operator=", 937, G___ROOT_DICT_Numerical_216_0_59, (int) ('u'), G__get_linked_tagnum(&G___ROOT_DICT_NumericalLN_geniecLcLSpline), -1, 1, 1, 1, 1, 0, "u 'genie::Spline' - 11 - -", (char*) NULL, (void*) NULL, 0);
   G__tag_memfunc_reset();
}
