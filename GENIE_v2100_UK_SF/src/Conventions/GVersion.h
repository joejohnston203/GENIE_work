...
#define __GENIE_RELEASE__      "2.9.0"
#define __GENIE_RELEASE_CODE__ GRELCODE(2,9,0) 

#define __GENIE_SVN_REVISION__ 6054
 

#define __GENIE_RELEASE_CANDIDATE__ 

/* 
 * SVN differences at compile time: 
*/ 
