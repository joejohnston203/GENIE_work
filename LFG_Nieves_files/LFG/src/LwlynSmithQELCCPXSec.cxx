...
{
  LOG("LwlynSmith",pFATAL) << "TESTING: Integral() called in LwlynsmithQEL";
...
void LwlynSmithQELCCPXSec::LoadConfig(void)
{
  ...
  // Check if the QELXSec settings say the Integral method should avgerage
  // over initial nucleons
  bool avgOverNucl = fConfig->GetBoolDef("AverageOverNucleonMomentum", false);
  LOG("LwlynSmith", pFATAL) << "TESTING: AverageOverNucleonMomentum = " << avgOverNucl;
}
//____________________________________________________________________________
