...
/*
 ...
 @ Mar 01, 2016 - JJ (SD)
   Added HitNucX4 methods in order to store and access the struck nucleon
   position.
...
void Target::Init(void)
{
  ...
  fHitNucX4  = new TLorentzVector(0,0,0,0);
}
//___________________________________________________________________________
...
//___________________________________________________________________________
void Target::SetHitNucX4(const TLorentzVector & x4)
{
  if(fHitNucX4) delete fHitNucX4;
  fHitNucX4 = new TLorentzVector(x4);
}
//___________________________________________________________________________
...
//___________________________________________________________________________
TLorentzVector * Target::HitNucX4Ptr(void) const
{
  if(!fHitNucX4) {
    LOG("Target", pWARN) << "Returning NULL struck nucleon 4-momentum";
    return 0;
...
void Target::Print(ostream & stream) const
{
  ...
  if( this->HitNucIsSet() ) {
    ...
    stream << " struck nucleon = " << p->GetName()
	   << ", P4 = " << utils::print::P4AsString(fHitNucP4)
	   << ", X4 = " << utils::print::X4AsStrgin(fHitNucX4) << endl;
  }
