...
#include "EVGModules/FermiMoverLFG.h"
...
FermiMoverLFG::FermiMoverLFG() :
EventRecordVisitorI("genie::FermiMoverLFG")
{

}
//___________________________________________________________________________
FermiMoverLFG::FermiMoverLFG(string config) :
EventRecordVisitorI("genie::FermiMoverLFG", config)
{
...
//___________________________________________________________________________
void FermiMoverLFG::ProcessEventRecord(GHepRecord * evrec) const
{
...
//___________________________________________________________________________
void FermiMoverLFG::KickHitNucleon(GHepRecord * evrec) const
{
  ...
  // Do default Fermi Moving
    ...
    if (fSRCRecoilNucleon) {
      ...
      // Calculate the Fermi momentum using an LFG model
...
//___________________________________________________________________________
void FermiMoverLFG::Emit2ndNucleonFromSRC(GHepRecord * evrec,
...
//___________________________________________________________________________
void FermiMoverLFG::AddTargetNucleusRemnant(GHepRecord * evrec) const
{
...
//___________________________________________________________________________
void FermiMoverLFG::Configure(const Registry & config)
{
  Algorithm::Configure(config);
  this->LoadConfig();
}
//____________________________________________________________________________
void FermiMoverLFG::Configure(string config)
{
  Algorithm::Configure(config);
  this->LoadConfig();
}
//____________________________________________________________________________
void FermiMoverLFG::LoadConfig(void)
{
